...
import { usePromptStore, PRESETS } from "@/lib/prompt-store"
          ...
          <div className="border-b border-border p-4">
            <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <h2 className="text-lg font-semibold gradient-text">All Presets</h2>
                    ...
                    <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            id="preset-subtitle"
                            placeholder="e.g., Retro aesthetic"
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea
                            id="preset-snippet"
                            placeholder="e.g., vintage film grain, warm tones, nostalgic"
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h3 className="text-sm font-medium gradient-text">Style Presets</h3>
          <Button
            variant="ghost"
            size="icon"
            className="h-6 w-6"
