...
const platforms = [
  ...
  { name: "Facebook", icon: Facebook, color: "text-[#1877F2]", bg: "bg-[#1877F2]/10 hover:bg-[#1877F2]/20", isComingSoon: true },
  { name: "Instagram", icon: Instagram, color: "text-[#E4405F]", bg: "bg-[#E4405F]/10 hover:bg-[#E4405F]/20", isComingSoon: true },
  { name: "YouTube", icon: Youtube, color: "text-[#FF0000]", bg: "bg-[#FF0000]/10 hover:bg-[#FF0000]/20", isComingSoon: true },
  { name: "Website / Blog", icon: Globe, color: "text-[#00C896]", bg: "bg-[#00C896]/10 hover:bg-[#00C896]/20", isComingSoon: true },
]
...
export default function LinksPage() {
  ...
  // Handle OAuth with form validation
  const handleOAuthConnect = (platform: string) => {
    ...
    const authPath = platform.toLowerCase().replace(/ \/ x/, '') // "Twitter / X" -> "twitter"
    ...
    <div className="min-h-screen bg-[#0A0B0F] text-white flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 pb-20 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
              {platforms.map(({ name, icon: Icon, color, bg, requiresOAuth, isComingSoon }, i) => {
                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center">
                            ...
                            {isComingSoon && (
                              <span className="ml-2 px-2 py-1 text-xs font-medium bg-yellow-500/20 text-yellow-400 rounded-full">Coming Soon</span>
                            )}
                          </div>
                    ...
                    {!isComingSoon && isFormVisible && (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          <Button
                            onClick={() => requiresOAuth ? handleOAuthConnect(name) : handleAddAccount(name)}
                            disabled={isLoading}
                    ...
                    {isComingSoon ? (
                      <Button
                        disabled
                        className="w-full text-xs sm:text-sm font-semibold py-2 h-9 rounded-lg transition-all flex items-center justify-center gap-2 bg-gradient-to-r from-yellow-600/20 to-orange-600/20 text-yellow-400 border border-yellow-500/20 cursor-not-allowed"
                      >
                        Coming Soon
                      </Button>
                    ) : (
