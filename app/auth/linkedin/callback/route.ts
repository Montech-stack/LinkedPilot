...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // ✅ Set cookies properly with NextResponse
    ...
    response.cookies.set('linkedin_access_token', access_token, cookieOptions)
    response.cookies.set('linkedin_user_id', profile.sub, cookieOptions)
